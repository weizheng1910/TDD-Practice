...
const { isDivisible, divisibleByFooBarQix } = require('../src/divisibleFooBarQix')
const { convertNumberIntoArray, isDigitFooBarQix, containsFooBarQix } = require('../src/containsFooBarQix')
